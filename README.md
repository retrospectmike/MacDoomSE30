# MacDoomSE/30
<p style="text-align: center;"><img width="318" height="199"  alt="image" src="https://github.com/user-attachments/assets/dadbf03c-6ef5-4995-80f6-b6ee47873afb" />
...
### Is it Playable?
Yes.  At time of writing, the frame rate is reasonable (3-10fps at the application's default graphics settings) for playing but additional work in not only performance but also black&white dithering and lighting settings might greatly enhance the appearance.  The Options screen tells you keys you can press in-game to adjust the dithering.
